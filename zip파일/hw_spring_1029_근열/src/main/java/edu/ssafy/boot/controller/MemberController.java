...
//			exceptionMethod(e, (Model) mv.getModel());
		...
		mv.setViewName("redirect:memsellist");
		return mv;
	}
	...
	@PostMapping("/login")
	public ModelAndView login(HttpServletRequest req, ModelAndView mv, HttpSession session){
		String uid = req.getParameter("uid");
		String upw = req.getParameter("upw");
		Member m = ser.selectOne(uid);
		if(m.getPw().equals(upw)) {
