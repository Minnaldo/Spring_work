...
<body>
	...
	<div class="main col-12" style="margin-left: 300px">
		<div align="right" style="margin-right: 300px">
			<form action="main.do?action=calo" method="post">
		...
		<div class="isotope-container row grid-space-10"
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="main.do?action=pdetail&code=20"><img width="200"
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="main.do?action=pdetail&code=7"><img width="200"
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="main.do?action=pdetail&code=8"><img width="200"
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="main.do?action=pdetail&code=11"><img width="200"
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="main.do?action=pdetail&code=6"><img width="200"
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="main.do?action=pdetail&code=2"><img width="200"
		...
		<form action="main.do?action=Login" id="popForm" method="post">
			...
			<div>
				...
				<div style="margin-top: 20px">
					...
					<button type="button" class="btn btn-gray btn-sm" onclick="location='findpw.jsp'">비밀번호 찾기</button>
				</div>
			</div>
		</form>
	</div>
	...
	<div class="modal fade" id="myModal" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<form action="signUp" name="registerform"
